...
export interface AppConfig {
  ...
  /** Operation-specific plan requirements (fall back to applyRequiresPlan if unset). */
...
export function loadConfig(env: NodeJS.ProcessEnv = process.env): AppConfig {
  ...
  return {
    ...
    // Operation-specific plan requirements — fall back to applyRequiresPlan.
    createRequiresPlan: env.CREATE_REQUIRES_PLAN !== undefined ? parseBool(env.CREATE_REQUIRES_PLAN, false) : parseBool(env.APPLY_REQUIRES_PLAN, true),
    updateRequiresPlan: env.UPDATE_REQUIRES_PLAN !== undefined ? parseBool(env.UPDATE_REQUIRES_PLAN, true) : parseBool(env.APPLY_REQUIRES_PLAN, true),
    deleteRequiresPlan: env.DELETE_REQUIRES_PLAN !== undefined ? parseBool(env.DELETE_REQUIRES_PLAN, true) : parseBool(env.APPLY_REQUIRES_PLAN, true),
    bulkRequiresPlan: env.BULK_REQUIRES_PLAN !== undefined ? parseBool(env.BULK_REQUIRES_PLAN, true) : parseBool(env.APPLY_REQUIRES_PLAN, true),
    updateByQueryRequiresPlan: env.UPDATE_BY_QUERY_REQUIRES_PLAN !== undefined ? parseBool(env.UPDATE_BY_QUERY_REQUIRES_PLAN, true) : true,
