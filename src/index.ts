  ...
  logger.info(
    {
      ...
      createRequiresPlan: config.createRequiresPlan,
      updateRequiresPlan: config.updateRequiresPlan,
      deleteRequiresPlan: config.deleteRequiresPlan,
      bulkRequiresPlan: config.bulkRequiresPlan,
      updateByQueryRequiresPlan: config.updateByQueryRequiresPlan,
